 ...
 * @tree:  Is a pointer to the root node to measure the height of the tree.
 * Return:A tree is NULL, your function must return 0.
**/
 ...
 * @tree: Is a pointer to the root node of the tree too.
